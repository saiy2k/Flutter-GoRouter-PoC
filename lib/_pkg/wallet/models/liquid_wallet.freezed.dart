...
class _$LiquidWalletImpl extends _LiquidWallet {
  ...
  @override
  String toString() {
    return 'LiquidWallet(id: $id, name: $name, balance: $balance, type: $type, network: $network, backupTested: $backupTested, lastSync: $lastSync, lastBackupTested: $lastBackupTested, mnemonic: $mnemonic)';
  }
